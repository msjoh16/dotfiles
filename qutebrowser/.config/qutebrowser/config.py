...
# Add new bookmark
config.unbind('M')
config.bind('<Ctrl-x>s', 'bookmark-add')

# Open bookmark in new tab
config.unbind('gB')
config.bind('<Ctrl-x><Ctrl-c>b', 'cmd-set-text -s :bookmark-load -t')

# Open bookmark in current tab
config.unbind('gb')
config.bind('<Ctrl-x>b', 'cmd-set-text -s :bookmark-load')
...
config.unbind('N')
config.bind('<Ctrl-k>', 'search-prev')

config.unbind('n')
config.bind('<Ctrl-j>', 'search-next')
...
# Open google - current tab
config.bind(',g', 'open https://www.google.com/')

# Open google - new tab (foreground)
config.bind(',G', 'open -t https://www.google.com/')

# Open claude - current tab
config.bind(',c', 'open https://claude.ai/')

# Open claude - new tab (foreground)
...
## Type: QtColor
c.colors.tabs.selected.even.bg = onclick

## Foreground color of selected even tabs.
## Type: QtColor
c.colors.tabs.selected.even.fg = hover

## Background color of selected odd tabs.
## Type: QtColor
c.colors.tabs.selected.odd.bg = onclick

## Foreground color of selected odd tabs.
## Type: QtColor
c.colors.tabs.selected.odd.fg = hover
...
# config.bind('gB', 'cmd-set-text -s :bookmark-load -t')w
